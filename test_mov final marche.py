...
class RobotController:
    def __init__(self, ip):
        print(f"Initialisation du système... Connexion à {ip} - test_mov final marche.py:10")
        self.got = ugot.UGOT()
    ...
    def eviter_obstacle(self, angle_cible):
        ...
        print(f"🛑 Zone de sécurité franchie ! Évitement par : {direction.upper()} - test_mov final marche.py:214")
    ...
    def run_mission(self):
        try:
            ...
            print("🏁 Mission accomplie ! Retour au point de départ. - test_mov final marche.py:297")
